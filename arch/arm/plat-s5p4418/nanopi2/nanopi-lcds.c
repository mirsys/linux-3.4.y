...
int CFG_DISP_PRI_RESOL_WIDTH = 1280;
int CFG_DISP_PRI_RESOL_HEIGHT = 720;
...
int CFG_DISP_PRI_CLKGEN0_DIV = 5;
...
int	CFG_DISP_PRI_PIXEL_CLOCK = (800000000 / 5);
...
static int __init lcd_setup(char * str)
{
    if((str != NULL) && (*str != '\0'))
    strcpy(lcdname, str);
	printk(KERN_DEBUG " lcdname Config :%s \n", str);
...
void nanopi2_lcd_select(void)
{
	if(strcmp(lcdname, "vga-1024x768") == 0)
	{
		...
		CFG_DISP_PRI_PIXEL_CLOCK = (800000000 / CFG_DISP_PRI_CLKGEN0_DIV);
	}
